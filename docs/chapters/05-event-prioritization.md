...
![Table 5.2: Urgency Level with Service Restoration Goal](../assets/images/Urgency Level with Service Restoration Goal.jpeg)

*Table 5.2: Urgency Level with Service Restoration Goal*
...
![Urgency × Impact Priority Matrix - Priority levels derived from impact and urgency](../assets/images/Urgency x Impact Priority Matrix.jpeg)

*Table 5.1: Urgency × Impact Priority Matrix - Priority levels derived from impact and urgency*
...
**Table 5.4: Priority Calculation Matrix (Impact × Urgency)**
...
![Response Time Targets by Priority Level](../assets/images/Response Time Target By Priority Levels.jpeg)

*Table 5.3: Response Time Targets by Priority Level*
...
**Table 5.5: Response Time Targets by Priority**
...
![5.1: Event Management Priority Flowchart](../assets/images/Event Management Priority Flowchart.jpeg)

*5.1: Event Management Priority Flowchart*
...
*Position:* Place after the Priority Matrix section, before Control Objective EM-C05
